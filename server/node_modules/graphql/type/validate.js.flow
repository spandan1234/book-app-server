...
import { type ASTNode, type NamedTypeNode } from 'graphql/language/ast';

import { isValidNameError } from 'graphql/utilities/assertValidName';
...
import { type GraphQLSchema, assertSchema } from 'graphql/type/schema';
import {
