...
import isInteger from "graphql/polyfills/isInteger.mjs";
...
import { GraphQLScalarType } from "graphql/type/definition.mjs"; // As per the GraphQL Spec, Integers are only treated as valid when a valid
