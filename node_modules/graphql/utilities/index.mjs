...
, getDescription } from "graphql/utilities/extendSchema.mjs"; // Sort a GraphQLSchema.
...
export { printSchema, printType, printIntrospectionSchema } from "graphql/utilities/printSchema.mjs"; // Create a GraphQLType from a GraphQL language AST.
...
export { astFromValue } from "graphql/utilities/astFromValue.mjs"; // A helper to use within recursive-descent visitors which need to be aware of
...
export { separateOperations } from "graphql/utilities/separateOperations.mjs"; // Strips characters that are not significant to the validity or execution
// of a GraphQL document.

export { stripIgnoredCharacters } from "graphql/utilities/stripIgnoredCharacters.mjs"; // Comparators for types

export { isEqualType, isTypeSubTypeOf, doTypesOverlap } from "graphql/utilities/typeComparators.mjs"; // Asserts that a string is a valid GraphQL name
...
export { BreakingChangeType, DangerousChangeType, findBreakingChanges, findDangerousChanges } from "graphql/utilities/findBreakingChanges.mjs";
// Report all deprecated usage within a GraphQL document.
export { findDeprecatedUsages } from "graphql/utilities/findDeprecatedUsages.mjs";
